...
class Player(pygame.sprite.Sprite):
    def __init__(self, pos, group, collision_sprites, tree_sprites, interaction, soil_layer, toggle_shop):
        ...
        #timers
        self.timers = {'tool use': Timer(350, self.use_tool), 'tool switch': Timer(200), 'seed use': Timer(200, self.use_seed), 'seed switch': Timer(200)}
        ...
        # sound
        self.watering = pygame.mixer.Sound('kindred/audio/water.mp3')
    ...
    def import_assets(self):
        ...
        for animation in self.animations.keys():
            full_path = 'kindred/graphics/character/' + animation
