...
class Plant(pygame.sprite.Sprite):
    def __init__(self, plant_type, groups, soil, check_watered):
        ...
        self.frames = import_folder(f'kindred/graphics/fruit/{plant_type}')
        self.soil = soil
...
class SoilLayer:
    def __init__(self, all_sprites, collision_sprites):
        ...
        #graphics
        self.soil_surfs = import_folder_dict('kindred/graphics/soil/')
        self.water_surfs = import_folder('kindred/graphics/soil_water/')
